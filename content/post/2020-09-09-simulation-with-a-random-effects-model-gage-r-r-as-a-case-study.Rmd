...
Why is it a random effects model?  What is a random effects model?  I am not a statistician and that discussion is way above my paygrade but there some good information [here](http://www.stat.columbia.edu/~gelman/research/published/banova7.pdf) for those who want to dive deeper.  ^[Conflicting definitions of random/mixed effects https://statmodeling.stat.columbia.edu/2005/01/25/why_i_dont_use/] .  While not a formal definition, it may be sufficient to know that random effects are estimated with partial pooling while others are not. 
