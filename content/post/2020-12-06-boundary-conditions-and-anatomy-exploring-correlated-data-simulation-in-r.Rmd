...
Now the data, kde estimate, and nearest probability contour region boundary are stored in one tibble.  From here we can set up a 3d plot that shows probability contours of inter
