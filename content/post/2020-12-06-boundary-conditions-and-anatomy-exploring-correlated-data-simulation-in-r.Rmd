...
__*EDIT 10 JANUARY 2021: After publishing this post I came to understand that the kernel density estimations towards the end require a boundary adjustment due to the lognormal shape of the data.  I will be posting an update as soon as I can free up a bit of time.  The coverage in that section is not wrong on a percentage basis but assigns positive probability to regions where no points would exist*__
